...
import JeuxdeQuebecProdactScreen from './screens/JeuxdeQuebecProdactScreen';
...
function App() {
  ...
  OneSignal.initialize('00d35a44-9d61-40ac-a8d0-bdc4fb01b4ee');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-01-30T10:00:00'); //дата з якої поч працювати webView
